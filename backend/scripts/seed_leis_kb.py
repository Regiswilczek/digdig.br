...
NOTA DE CURADORIA: Curadoria orientada à AUDITORIA de atos administrativos, financeiros, éticos e disciplinares. Foram preservados os artigos que definem competências, limites de alçada, vedações, impedimentos, mandatos, transparência, e regras de despesa. Foram omitidos: ritos detalhados de reuniões, pautas, prazos internos de convocação, organização de câmaras temáticas e técnicas, e dispositivos meramente procedimentais. Onde houve omissão, marca-se "(...)".

════════════════════════════════════════════════════════════════
CAPÍTULO II — DOS CONSELHEIROS (Art. 11–31)
════════════════════════════════════════════════════════════════

Art. 11. O(A) conselheiro(a) do CAU/PR é o profissional eleito como representante dos arquitetos e urbanistas do Estado do Paraná, de acordo com atos normativos do CAU/BR e legislação específica.

Art. 13. O exercício do cargo de conselheiro(a) do CAU/PR é honorífico, decorrente, portanto, da honorabilidade e da notória capacidade profissional de quem ocupa.

Art. 14. Todo conselheiro(a) do CAU/PR, durante o exercício do seu cargo ou em decorrência deste, deverá agir segundo os princípios da Administração Pública conforme o caput do Art. 37 da Constituição Federal.

Art. 15. Os mandatos de conselheiro(a) titular e de suplente de conselheiro terão duração de 3 (três) anos, iniciando-se em 1° de janeiro do primeiro ano, e encerrando-se em 31 de dezembro do terceiro ano do mandato para o qual foi eleito, sendo permitida apenas uma recondução para o mesmo mandato.

Art. 16. É vedado ao arquiteto e urbanista ocupar o cargo de conselheiro(a) do CAU/PR por mais de 2 (dois) mandatos sucessivos, estando ele na condição de conselheiro(a) titular ou de suplente de conselheiro(a), conforme atos normativos do CAU/BR.
Parágrafo único. A alternância entre o exercício de mandatos de conselheiro(a) do CAU/PR não configura recondução.

Art. 22. É vedado a conselheiro(a) titular e a suplente de conselheiro(a), licenciado ou não, assumir cargo ou função administrativa, com ou sem remuneração, no CAU/BR ou em outro CAU/UF, no período de seu mandato.

Art. 23. Perderá o mandato, o conselheiro(a) que, no período correspondente ao ano civil, faltar sem justificativa a 3 (três) reuniões Plenárias e/ou reuniões de comissões ordinárias, as quais tenham sido convocados em caráter ordinário.
§ 2º As faltas em reuniões extraordinárias mesmo que deliberativas, não serão contabilizadas como faltas.

Art. 25. O(A) Conselheiro(a) poderá licenciar-se:
I - por doença, devidamente comprovada;
II - por licença maternidade por prazo não superior a 180 dias e paternidade por não superior a 20 dias;
III - para tratar de interesse particular, por prazo não inferior a 30 dias e não superior a 120 dias;
IV - Os casos não previstos, serão apreciados e deliberados pelo Conselho Diretor, ou, na falta deste, pelo Plenário.
§ 1º A licença para tratar de interesse particular poderá ser renovada mediante pedido, desde que o somatório dos períodos de licença não ultrapasse o limite de 120 dias por ano.

Art. 26. O(A) conselheiro(a) deverá manifestar-se à presidência do conselho, ou à coordenação da comissão da qual seja membro, quando considerar-se impedido ou em suspeição para relatar matéria.
§ 1º Há impedimento nos casos em que o conselheiro:
I - tenha interesse direto ou indireto na matéria;
...
§ 2° É suspeito o(a) conselheiro(a) que tenha amizade ou inimizade notória com qualquer das partes ou com os respectivos cônjuges, companheiros, parentes e afins até o terceiro grau.
§ 5° A omissão do dever de comunicar o impedimento constitui falta grave, para efeitos disciplinares.
§ 6° A omissão do dever de declarar o impedimento constitui falta grave, para efeitos disciplinares.

Art. 28. Compete ao conselheiro(a) do CAU/PR:
I - cumprir e fazer cumprir a legislação federal, o Regimento Geral do CAU, as resoluções, o Regimento Interno do CAU/PR, as deliberações plenárias e os demais atos normativos do CAU/BR e CAU/PR;
II - cumprir e fazer cumprir o Código de Ética e Disciplina;
IV - conhecer e se comprometer com suas responsabilidades legais e morais do cargo, respeitando e cumprindo o código de conduta e decoro do CAU/PR;
VI - declarar-se impedido ou suspeito na apreciação de matéria em que possa haver comprometimento da imparcialidade;
VII - arguir o impedimento ou a suspeição de outro conselheiro desde a distribuição do processo até o início do julgamento.

ATENÇÃO AUDITORIAL — CONSELHEIROS:
- Art. 16: limite de 2 mandatos sucessivos é base para detectar concentração de poder (ICP).
- Art. 22: vedação de acumulação de cargos no Conjunto Autárquico — flagrar nomeações cruzadas.
- Art. 23: perda automática de mandato por 3 faltas injustificadas no ano civil — auditar listas de presença.
- Art. 25: licença "interesse particular" tem TETO de 120 dias/ano — período maior é irregular.
- Art. 26 §§ 5º e 6º: omitir impedimento é FALTA GRAVE disciplinar.

════════════════════════════════════════════════════════════════
CAPÍTULO III — DO PLENÁRIO (Art. 32–81)
════════════════════════════════════════════════════════════════
...
I - Pela maioria absoluta nas matérias dos incisos XI (bens imóveis) e XXV (julgamento de recursos) do Art. 34;
II - Pela maioria de 3/5 nas matérias dos incisos XXXVI, XXXIX e XLI do Art. 34.

Art. 50. O quórum para instalação e funcionamento das reuniões plenárias corresponde ao número inteiro imediatamente superior à metade dos membros do Plenário.

Art. 59. A apreciação de matéria constante da ordem do dia obedecerá às seguintes regras:
(...)
VIII - durante a discussão, não será permitido o uso da palavra ao conselheiro em suspeição ou em impedimento;
(...)

Art. 61. Em situações que exijam cumprimento de prazos antes da realização de reuniões plenárias, o presidente poderá praticar atos ad referendum do Plenário, cabendo sua apreciação na primeira reunião plenária subsequente.
§ 1º O presidente apresentará ao Plenário as razões que o levaram a praticar o ato ad referendum.
§ 2º O Plenário deliberará sobre o referendo e os possíveis efeitos da aprovação, revogação, anulação ou alteração do ato.

Art. 66. O presidente poderá, em caráter excepcional, suspender deliberação plenária, fazendo-o por meio de ato fundamentado, quando verificar a ocorrência de ilegalidade, contrariedade ou conflito com atos normativos vigentes, ou por interesse público.
§ 1º O ato fundamentado que suspender os efeitos da deliberação plenária terá vigência até a reunião plenária ordinária subsequente quando, obrigatoriamente, os motivos apresentados pelo presidente serão apreciados pelo Plenário.
§ 2º Caso os motivos da suspensão não sejam apresentados pelo presidente, ou não sejam acolhidos, o ato de suspensão perderá sua eficácia e a vigência da deliberação plenária será restabelecida imediatamente.

Art. 68. Da deliberação plenária que resultar sanções, caberá pedido de revisão apresentado pela parte legitimamente interessada, sem efeito suspensivo, desde que apresentados fatos novos ou circunstâncias relevantes que justifiquem a inadequação da sanção.

Art. 70. A decisão que der provimento ao pedido de revisão não poderá acarretar agravamento da sanção.

Art. 80. O(A) conselheiro(a) poderá ter arguidos ou declarados a suspeição ou o impedimento, se constatados os casos definidos para cada situação prevista no Código de Processo Civil.
§ 1º Quando arguida suspeição de conselheiro em reunião do Plenário, caberá ao arguente a comprovação de suas razões, que serão apreciadas pelos membros do Plenário, na mesma reunião.

Art. 81. Os atos do Plenário entram em vigor nos prazos e na forma por eles determinados.

ATENÇÃO AUDITORIAL — PLENÁRIO:
- Art. 34: define o LIMITE DE ALÇADA do Presidente. Atos financeiros de grande vulto (imóveis, convênios com repasse, criação de cargos, planos de salários, auditoria independente) exigem aprovação prévia do Plenário.
- Art. 34, XLIV + Art. 61: atos ad referendum DEVEM ser pautados na reunião plenária subsequente — descumprimento é irregularidade.
- Art. 35, par. único: atos sobre bens imóveis exigem MAIORIA ABSOLUTA — verificar quórum nas atas.
- Art. 59 VIII + Art. 80: conselheiro impedido/suspeito não pode usar palavra na discussão — auditar votações em causa própria via atas.

════════════════════════════════════════════════════════════════
CAPÍTULO IV — DAS COMISSÕES ORDINÁRIAS E ESPECIAIS (Art. 82–125)
════════════════════════════════════════════════════════════════

Art. 84. Serão instituídas, no CAU/PR, as seguintes comissões ordinárias:
I - Comissão de Organização e Administração - COA-CAU/PR;
II - Comissão de Planejamento e Finanças - CPFi-CAU/PR;
III - Comissão de Ensino e Formação – CEF-CAU/PR;
IV - Comissão de Ética e Disciplina - CED-CAU/PR; e
V - Comissão de Exercício Profissional - CEP-CAU/PR.

Art. 85. As comissões ordinárias serão compostas por no mínimo 03 (três) conselheiros titulares, preferencialmente mantendo a distribuição igualitária de membros entre as comissões.

Art. 86. Os mandatos dos membros de comissões ordinárias terão duração de 01 (um) ano, sendo permitida a recondução iniciando-se na primeira reunião plenária ordinária do ano e encerrando-se na primeira reunião plenária ordinária do ano seguinte.
§ 1º As comissões ordinárias serão compostas apenas por membros conselheiros titulares do CAU/PR.
§ 2º O presidente do CAU/PR não poderá ser membro de comissão ordinária.

Art. 95. Cada conselheiro(a) titular poderá participar de apenas 1 (uma) comissão especial.

Art. 96. Compete às comissões ordinárias e especiais:
...
(...)
X - elaborar e deliberar sobre os planos de ação e orçamento e os planos de trabalho da comissão, e suas alterações;
...
Art. 99. Compete à Comissão de Ética e Disciplina (CED-CAU/PR), no âmbito de sua competência, zelar pela verificação e cumprimento dos artigos 17 a 23 da Lei n° 12.378/2010 e do Código de Ética e Disciplina:
I - propor aprimoramento de atos normativos referentes à ética e disciplina;
II - instruir, apreciar e deliberar sobre processos de infrações ético-disciplinares dos artigos 17 a 23 da Lei n° 12.378, para apreciação do Plenário do CAU/PR;
III - propor, apreciar e deliberar sobre apuração de irregularidades e responsabilidades relacionadas a ética e disciplina;
(...)

Art. 100. Compete à Comissão Exercício Profissional (CEP-CAU/PR), no âmbito de sua competência, zelar pela orientação e fiscalização do exercício da Arquitetura e Urbanismo:
(...)
IV - propor, apreciar e deliberar sobre o Plano de Fiscalização do CAU/PR;
...
(...)
X - propor, apreciar e deliberar sobre apuração de irregularidades e responsabilidades relacionadas a exercício profissional.

Art. 101. Compete à Comissão de Organização e Administração (COA-CAU/PR), no âmbito de sua competência, zelar pelo funcionamento do CAU/PR:
I - propor, apreciar e deliberar sobre atos normativos relativos à gestão da estratégia organizacional, atendimento, funcionamento, patrimônio e administração;
III - propor, apreciar e deliberar sobre apuração de irregularidades e responsabilidades relacionadas a aspectos organizacionais e administrativos;
IV - propor, apreciar e deliberar sobre propostas de aquisição ou alienação de bens móveis e imóveis pelo CAU/PR;
V - propor, apreciar e deliberar sobre o Regimento Interno do CAU/PR e suas alterações;
X - propor, apreciar, deliberar e monitorar o cumprimento da legislação referente ao acesso à informação e à transparência no CAU/PR.

Art. 102. Compete à Comissão de Planejamento e Finanças (CPFi-CAU/PR), no âmbito de sua competência, zelar pelo planejamento e equilíbrio econômico-financeiro:
IV - propor, apreciar e deliberar sobre apuração de irregularidades e responsabilidades relacionadas a aspectos econômico-financeiros;
V - propor, apreciar e deliberar sobre proposta de aquisição ou alienação de bens móveis e imóveis pelo CAU/PR (aspecto econômico-financeiro);
VI - propor, apreciar e deliberar sobre os planos de ação e orçamento do CAU/PR, e suas reformulações;
IX - propor, apreciar e deliberar sobre processos de cobrança de anuidades, taxas e multas;
XI - propor, apreciar e deliberar sobre a prestação de contas do CAU/PR;
XII - propor, apreciar e deliberar sobre tomada de contas especial no CAU/PR;
XIII - propor, apreciar, deliberar e monitorar os repasses de recursos do CAU/PR e suas aplicações;
XV - apreciar, deliberar e monitorar o comportamento das receitas e das despesas do CAU/PR;
XVI - propor, apreciar e deliberar sobre alterações de despesas não previstas nos planos de ação e orçamento do CAU/PR.

ATENÇÃO AUDITORIAL — COMISSÕES:
- Art. 84: cinco comissões ordinárias (COA, CPFi, CEF, CED, CEP). Cada uma tem competência fiscalizatória específica — ato sobre matéria que escapou da comissão competente é IRREGULAR.
- Art. 86 §2º: o PRESIDENTE NÃO PODE ser membro de comissão ordinária — auditar composições.
- Art. 86: mandato de comissão é de 1 ANO — composição estável por mais de 1 ano sem recondução é irregularidade.
- Art. 95: cada conselheiro só pode participar de 1 comissão especial — flagrar acumulação.
- Art. 99: PED (Processo Ético-Disciplinar) é instruído pela CED — Presidente não pode arquivar denúncia bypassando a comissão.
- Art. 100: fiscalização do exercício profissional é DEVER da CEP — não fazê-lo é omissão.
- Art. 102: TOMADA DE CONTAS ESPECIAL é prerrogativa da CPFi — Presidente não pode bloquear.

════════════════════════════════════════════════════════════════
CAPÍTULO VIII — DO PRESIDENTE E DO VICE-PRESIDENTE (Art. 199–215)
════════════════════════════════════════════════════════════════

Art. 199. O presidente será eleito por maioria de votos dos conselheiros titulares, em votação secreta.
§ 1º A eleição e posse do presidente serão efetuadas na primeira reunião plenária ordinária a ser realizada até o 10º dia útil do mês de janeiro do ano subsequente ao da eleição dos conselheiros.

Art. 201. O período de mandato de presidente é de 3 (três) anos, iniciando-se na data de sua posse e encerrando-se no dia 31 de dezembro do terceiro ano do mandato para o qual foi eleito.

Art. 202. O exercício do cargo de presidente é honorífico.

Art. 203. O presidente será substituído nas suas faltas, impedimentos e licenças pelo vice-presidente, no exercício de seu cargo, e, na ausência desse, pelo conselheiro titular mais idoso.
Parágrafo único. Em caso de renúncia, destituição ou falecimento, o presidente será substituído pelo vice-presidente.

Art. 207. O presidente do CAU/PR será destituído:
I - no caso de perda do mandato como conselheiro na forma do § 2° do Art. 36 da Lei n° 12.378/2010; e
II - pelo voto de 3/5 (três quintos) dos conselheiros titulares na forma do § 3° do Art. 36 da Lei n° 12.378/2010, em votação secreta.
§ 1º O processo de destituição deverá ocorrer em plenária extraordinária com pauta única.
§ 2º Em caso de aprovação da destituição do presidente, a plenária homologa a ascensão do vice-presidente ao cargo.

Art. 213. O vice-presidente do CAU/PR será destituído:
I - no caso de perda do mandato como conselheiro;
II - pelo voto de 3/5 do Plenário, em votação secreta.

Art. 214. Compete ao presidente do CAU/PR:
I - cumprir e fazer cumprir a legislação federal, as resoluções, os atos normativos e as deliberações plenárias baixados pelo CAU/BR, o Regimento Geral do CAU e o Regimento Interno do CAU/PR;
II - cumprir e fazer cumprir os atos baixados pelo CAU/PR;
...
XXXIII - propor ao Conselho Diretor e ao Plenário a instauração de comissão temporária para apuração de irregularidades e responsabilidades no CAU/PR;
(...)
...
XLIV - assinar atestados, certidões e certificados conferidos pelo CAU/PR;
(...)
LI - assegurar a gestão da informação do CAU/PR, por meio do Portal da Transparência e do Serviço de Informações ao Cidadão, observando o cumprimento de prazos, realizando auditorias de forma rotineira, conforme atos normativos do CAU/BR;
(...)
...
ATENÇÃO AUDITORIAL — PRESIDÊNCIA:
- Art. 199, 201: presidente eleito em VOTAÇÃO SECRETA, mandato de 3 ANOS — alinha com mandato de conselheiro.
- Art. 202: cargo HONORÍFICO — não há salário; verbas indenizatórias seguem Art. 256.
- Art. 207: destituição exige 3/5 do Plenário em votação secreta com pauta única extraordinária — qualquer outro rito é nulo.
- Art. 214 LIII: nomeação de não-concursados restrita a "direção, chefia e assessoramento" (regra do Art. 37, V CF/88).
- Art. 214 LIX: pagamentos só de despesas APROVADAS PELO PLENÁRIO. "Despesa emergencial" sem ratificação é irregularidade.
- Art. 214 LX: movimentação bancária exige ASSINATURA CONJUNTA Presidente + Gerente Geral.
- Art. 214 LXI: delegação de assinatura de contratos exige ATO NORMATIVO DO PLENÁRIO definindo limites.
- Art. 215 §2º: portaria publicada com mais de 1 DIA ÚTIL de atraso é violação de transparência ativa.

════════════════════════════════════════════════════════════════
CAPÍTULO IX — DO CONSELHO DIRETOR (Art. 216–229)
════════════════════════════════════════════════════════════════

Art. 218. Compete ao Conselho Diretor:
I - apreciar e deliberar sobre matérias de caráter legislativo, normativo ou contencioso em tramitação;
II - apreciar e deliberar sobre o calendário anual de reuniões;
...
IX - apreciar e deliberar sobre as rotinas administrativas, os instrumentos normativos de gestão de pessoas e os planos de comunicação;
X - apreciar e deliberar sobre as diretrizes de elaboração, consolidação e monitoramento dos planos de ação e orçamento;
XI - apreciar e deliberar sobre os resultados de gestão dos planos de ação e orçamento e dos planos de trabalho;
XIII - propor, apreciar e deliberar sobre abertura de editais para concessão de apoio institucional;
XV - apreciar e deliberar sobre propostas de concessão de apoio institucional às atividades de Assistência Técnica para Habitação de Interesse Social;
...
XVII - apreciar e deliberar sobre a realização e composição de missões internacionais.

Art. 219. O Conselho Diretor manifesta-se sobre assuntos de sua competência mediante ato administrativo da espécie deliberação do Conselho Diretor.

Art. 227. O Conselho Diretor decide por maioria simples de votos.

ATENÇÃO AUDITORIAL — CONSELHO DIRETOR:
- Art. 218 VIII: concessão de DIÁRIAS, PASSAGENS E JETONS é decisão do Conselho Diretor — auditar atos de Presidente que concedam essas verbas sem passar pelo CD.
- Art. 218 VI/VII: contratação de serviços, aquisição e alienação de bens móveis ficam sob alçada do CD (limites definidos em norma do Plenário).
- Art. 218 XVI: convênios e parcerias passam pelo CD — Presidente assinar (Art. 214 XLIII) sem deliberação prévia do CD ou Plenário (conforme valor) é irregularidade.

════════════════════════════════════════════════════════════════
CAPÍTULO XI — DISPOSIÇÕES GERAIS (Art. 254–259)
════════════════════════════════════════════════════════════════

Art. 254. As eleições do CAU/PR serão regidas pelo Regulamento Eleitoral para as Eleições de Conselheiros do CAU/BR e dos CAU/UF.

Art. 255. Será vedado ao CAU/PR manifestar-se sobre assuntos de caráter religioso ou político-partidário.

Art. 256. O CAU/PR, baseado nos limites regulamentados pelo CAU/BR, definirá os valores de verbas indenizatórias do presidente, conselheiros, membros de colegiados, empregados, convidados e colaboradores eventuais.

Art. 257. O CAU/PR poderá autorizar a prestação de assistência jurídica em processos cíveis ou criminais, em litígios que envolvam atos praticados no regular exercício de suas funções como conselheiros à presidente, ex-presidentes, conselheiros, ex-conselheiros, funcionários e ex-funcionários.
...
Art. 259. Os casos omissos neste regimento interno serão resolvidos pelo Plenário do CAU/PR.

ATENÇÃO AUDITORIAL — DISPOSIÇÕES GERAIS:
- Art. 255: VEDAÇÃO TOTAL de manifestação política-partidária ou religiosa pelo CAU/PR — manifestações públicas do Presidente em nome do conselho com viés partidário são irregulares.
- Art. 256: VERBAS INDENIZATÓRIAS têm teto regulado pelo CAU/BR — pagamentos acima do teto são irregularidades graves.
- Art. 257: ASSISTÊNCIA JURÍDICA do CAU pode ser concedida apenas para atos praticados NO REGULAR EXERCÍCIO. Defesa de presidente em processo por atos de improbidade (fora do exercício regular) é irregular. Exige requerimento com relatório e voto do Plenário — não pode ser despacho do Presidente.

════════════════════════════════════════════════════════════════
METADADOS PARA SEED DA KNOWLEDGEBASE
════════════════════════════════════════════════════════════════
tipo: regimento
titulo: Regimento Interno do CAU/PR (curado para auditoria)
